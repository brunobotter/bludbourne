...
public class MapManager {
    ...
    public Vector2 getPlayerStartUnitScaled() {
        ...
        playerStart.set(_playerStart.x * UNIT_SCALE,
                _playerStart.y * UNIT_SCALE);
        return playerStart;
    }

    private void setClosestStartPosition(final Vector2 position) {
        //Obter a ultima posição conhecida neste mapa
        _playerStartPositionRect.set(0, 0);
        _closestPlayerStartPosition.set(0, 0);
        float shortestDistance = 0f;
        //Percorre todas as posições iniciais dos jogadores e escolhe a mais proxima
