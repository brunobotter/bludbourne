...
public class Entity {
    ...
    private static final String _defaultSpritePath =
    ...
    public void update(float delta) {
        _frameTime = (_frameTime + delta) % 5; //Quer evitar o estouro
        //Queremos que o hitbox fique aos pes para uma melhor sensação
    ...
    public void setBoundingBoxSize(float percentageWidthReduced,
        ...
        //Atualiza a caixa delimitadora atual
        float width;
        float height;
        ...
        //Precisa levar em conta a escala unitaria ja que as coordenadas do mapa sera em pixel
        float minX;
        float minY;
    ...
    private void loadAllAnimations() {
        //Animação andandno
        Texture texture = Utility.getTextureAsset
                (_defaultSpritePath);
    ...
    public void setDirection(Direction direction, float
        ...
        //Examina a variavel apropriada ao mudar de posição
