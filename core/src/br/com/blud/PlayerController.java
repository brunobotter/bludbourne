...
public class PlayerController implements InputProcessor {
    ...
    //Inicializa o hashmap para entradas staticas
    static {
    ...
    public boolean touchDown(int screenX, int screenY, int pointer,
        ...
        //esquerda e a seleção  a direita e o menu de contexto
    ...
    public void selectMouseButtonReleased(int x, int y){mouseButtons.put(Mouse.SELECT, false);
    }
